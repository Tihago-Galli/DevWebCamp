<footer class="footer">
    <div class="footer__grid">
        ...
        <h3 class="footer__logo"> &#60;DevWevCamp/></h3>
        <p class="footer__texto">
            DevWebCamp es una conferencia para dessarrolladores de todos los niveles,se lleva a cabo de forma presencial y en linea.
        </p>
        </div>
