<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <textarea 
         ...
         rows="5"><?php echo  $evento->descripcion ?></textarea>
    </div>
        ...
        <label for="categoria" class="formulario__label">Selecciona el dia</label>
                ...
                <?php foreach($dias as $dia){ ?>
                    <div>  
                        ...
                        <input type="radio" value="<?php echo $dia->id ?>" name="dia" id="<?php echo strtolower($dia->nombre) ?>" <?php echo ($evento->dia_id === $dia->id) ? 'checked' : ''; ?>>
    ...
    <label class="formulario__label">Selecciona Extra</label>
