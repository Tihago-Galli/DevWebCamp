...
(function(){
    ...
    function mostrarEventos(animar = true){
        //limpiar el html
        limpiarEvento();
        ...
        if(eventos.length > 0){
            ...
            if(animar){
                const ultimoRegistro = resumen.lastElementChild
                ultimoRegistro.classList.add('animacion');
            }

            
        }else {
            const noRegistro = document.createElement('P');
            noRegistro.textContent = 'No hay eventos, añade hasta 5 del lago izquierdo';
